...
*/
class ProductpageG extends StatefulWidget {
  @override
  _ProductpageGState createState() => new _ProductpageGState();
}

class _ProductpageGState extends State<ProductpageG> {
  @override
            ...
            child: Stack(
              ...
              children: <Widget>[
                ...
                Positioned(
                  right: -40.0,
                  bottom: -60.0,
                  child: Image.network("https://cdn0.iconfinder.com/data/icons/occupation-and-industry/64/badge-label-buy-sale-now-512.png",
